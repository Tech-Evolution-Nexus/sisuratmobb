...
public class DashboardRtFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.ViewBeritaRt);
    ...
    private void ambilDataBerita() {
        beritaRtList.add(new BeritaRt("Pengembangan", "", "", R.drawable.berita));
        beritaRtList.add(new BeritaRt("Berita Lain", "Pengembangan", "", R.drawable.beritaw));
